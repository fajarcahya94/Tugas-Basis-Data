<?php
    ...
    $pmjman = query("SELECT * FROM peminjaman WHERE id_peminjaman = $idpeminjaman")[0];
...
<body>
    ...
    <li>
        ...
        <li><button type="submit" name="submit">Edit Peminjaman</button></li>
    </ul>
    </form>
</body>
</html>